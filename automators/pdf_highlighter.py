...
def redact_matching_data(page, matched_values):
    ...
    for val in matched_values:
        ...
        #[page.addRedactAnnot(area, text=" ", fill=(0, 0, 0)) #here is where we can add highlight
        [page.addRedactAnnot(area, text=" ", fill=(228, 208, 10)) #here is where we can add highlight
